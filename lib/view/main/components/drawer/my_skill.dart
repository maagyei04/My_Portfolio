  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(percentage: 0.85, title: 'Getx',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.93, title: 'HTML5 & CSS3',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.70, title: 'ReactJS',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.60, title: 'Laravel',image: 'assets/icons/dart.png'),
